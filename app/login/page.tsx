    ...
    <div className="relative min-h-screen bg-background overflow-hidden flex items-center justify-center px-6">
      ...
      <motion.div
        ...
        <div className="rounded-[24px] bg-card p-8 shadow-[0_8px_24px_rgba(0,0,0,0.08)] border border-border backdrop-blur-md">
          ...
          <p className="text-sm text-muted-foreground text-center mt-2">Log in to continue growing your presence</p>
          ...
          <form className="mt-6 space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="#" className="text-xs text-muted-foreground hover:text-[#4CAF50] transition-colors">
                Forgot password?
              </Link>
            </div>
