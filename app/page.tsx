        ...
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-[16px] bg-[#A7D7A0]">
              <Leaf className="h-5 w-5 text-[#2E2E2E]" />
            </div>
            <span className="text-xl font-semibold text-foreground">TrendBloom</span>
          </div>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-foreground leading-tight text-balance">
              ...
              <span className="text-[#4CAF50]">Naturally</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              Track trends, discover viral content, and plan your posts with a dashboard 
              designed to help your social media flourish like nature itself.
            </p>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="mt-4 text-[#2E2E2E]/80 max-w-lg mx-auto">
              Join thousands of creators who are growing their audience naturally with TrendBloom.
            </p>
            <Link
              href="/dashboard/metrics"
